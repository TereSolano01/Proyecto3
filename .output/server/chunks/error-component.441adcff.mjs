...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.5ef40c1f.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.08667e46.mjs'));
...
//# sourceMappingURL=error-component.441adcff.mjs.map
