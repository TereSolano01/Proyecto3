import { getCurrentInstance, inject, computed, defineComponent, provide, h, Suspense, Transition, reactive, isRef, resolveComponent, watchEffect, ref, markRaw, mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, shallowRef, createApp, toRef, defineAsyncComponent, onErrorCaptured, unref } from 'vue';
...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSuspense } from 'vue/server-renderer';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Section, mergeProps({
    id: "blog",
    class: "text-typography_primary"
  }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<nav data-v-ff276254${_scopeId}><ul data-v-ff276254${_scopeId}><li data-v-ff276254${_scopeId}>`);
        ...
        _push2(`</li><li data-v-ff276254${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtLink, { to: "/albums_index" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`\xC1lbumes`);
            } else {
        ...
        _push2(`</li><li data-v-ff276254${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtLink, { to: "/compositors_index" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`Compositores`);
            } else {
        ...
        _push2(`</li><li data-v-ff276254${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtLink, { to: "/movies_index" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`Pel\xEDculas`);
            } else {
        ...
        return [
          createVNode("nav", null, [
            createVNode("ul", null, [
              ...
              createVNode("li", null, [
                createVNode(_component_NuxtLink, { to: "/albums_index" }, {
                  default: withCtx(() => [
                    createTextVNode("\xC1lbumes")
                  ]),
                  _: 1
              ...
              createVNode("li", null, [
                createVNode(_component_NuxtLink, { to: "/compositors_index" }, {
                  default: withCtx(() => [
                    createTextVNode("Compositores")
                  ]),
                  _: 1
              ...
              createVNode("li", null, [
                createVNode(_component_NuxtLink, { to: "/movies_index" }, {
                  default: withCtx(() => [
                    createTextVNode("Pel\xEDculas")
                  ]),
                  _: 1
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-ff276254"]]);
const _sfc_main$2 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(_attrs)} data-v-52ca5131><div class="columna" data-v-52ca5131><p data-v-52ca5131>\xA92023 Tere Solano | All Rights Reserved</p></div><div class="columna" data-v-52ca5131><img class="logo" src="https://cms-una.000webhostapp.com/assets/link/7ebcd6a564656540930001ae" alt="" data-v-52ca5131></div><div class="columna iconos" data-v-52ca5131><div data-v-52ca5131><i class="fab fa-facebook" data-v-52ca5131></i><i class="fab fa-instagram" data-v-52ca5131></i><i class="fas fa-envelope" data-v-52ca5131></i></div></div></footer>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-52ca5131"]]);
const meta$6 = void 0;
const meta$5 = void 0;
const meta$4 = void 0;
const meta$3 = void 0;
...
const routes = [
  {
    name: "albums-slug",
    path: "/albums/:slug(.*)*",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/albums/[...slug].vue",
    children: [],
    meta: meta$6,
    alias: [],
    component: () => import('./_...slug_.495465fe.mjs').then((m) => m.default || m)
  },
  {
    name: "albums_index",
    path: "/albums_index",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/albums_index.vue",
    children: [],
    meta: meta$5,
    alias: [],
    component: () => import('./albums_index.cf31f6c2.mjs').then((m) => m.default || m)
  },
  {
    name: "compositors-slug",
    path: "/compositors/:slug(.*)*",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/compositors/[...slug].vue",
    children: [],
    meta: meta$4,
    alias: [],
    component: () => import('./_...slug_.3e74cd72.mjs').then((m) => m.default || m)
  },
  {
    name: "compositors_index",
    path: "/compositors_index",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/compositors_index.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./compositors_index.7d4193d7.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/index.vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./index.6bd33043.mjs').then((m) => m.default || m)
  },
  {
    name: "movies-slug",
    path: "/movies/:slug(.*)*",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/movies/[...slug].vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./_...slug_.169dcc55.mjs').then((m) => m.default || m)
  },
  {
    name: "movies_index",
    path: "/movies_index",
    file: "C:/Users/Tere Solano/projects/Proyecto2-TereSolano/pages/movies_index.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./movies_index.dc5473af.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.441adcff.mjs'));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$1 as a, __nuxt_component_0$2 as b, __nuxt_component_2 as c, useNuxtApp as d, entry$1 as default, useHead as e, useRoute as u };
